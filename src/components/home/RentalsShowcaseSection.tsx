...
export default function RentalsShowcaseSection() {
  ...
  return (
    ...
    >
      <Container maxWidth="xl">
        <SectionTitle
          title="Alquileres"
          subtitle="Equipo premium listo para rodar. Video Village y wireless sin fricción."
        />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                      <Button
                        ...
                        onClick={() => handleCtaClick(item.prefillLabel, "availability")}
                      >
